        ...
        <div>
            ...
            <div>
                <div className='  '>
                    ...
                    <div className=' w-full  p bg-neutral text-neutral-content '>
                        <footer className=" container  mx-auto footer p-10 ">
                            <div>

                                <p className="pacifico my-2 flex text-orange-500 items-center font-bold  text-xl">
                                    Bd Bikes
                                </p>
                            </div>
                            <div>
                                ...
                                <span className="footer-title">Copyright © 2022 BdBike B.V. All rights reserved.</span>
